...
export const getOutputSchema = {
  ...
  description: 
    ...
    'by referencing the address without needing to recreate the Output. This enables secure handling ' +
    'of outputs and their associated descriptors.',
  strict: true,
  parameters: {
    type: 'object',
    properties: {
      descriptor: {
        type: 'string',
        description: 'The descriptor string that defines the output (e.g., "wpkh([d34db33f/44\'/0\'/0\']xpub6ERApfZwUNrhLCkDtcHTcxd75RbzS1ed54G1LkBUHQVHQKqhMkhgbmJbZRkrgZw4koxb5JaHWkY4ALHY2grBGRjaDMzQLcgJvLJuZZvRcEL/0/*)")'
      },
      networkType: {
        type: 'string',
      ...
      signersPubKeys: {
        ...
        description: 'Array of public keys (in hex) that will be used for signing. Only needed for complex descriptors with multiple spending paths.'
      },
      index: {
        type: 'number',
        description: 'Index to use for ranged descriptors'
      }
    },
